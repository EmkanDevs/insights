...
@frappe.whitelist()
def get_customer_details(customer_code, customer_name, doctype, details, filters=None):
    ...
    if doctype == "Sales Order":
        return get_sales_order_data(customer_code, customer_name, start_date, end_date, details)
    
    elif doctype == "Delivery Note":
        return get_delivery_note_data(customer_code, customer_name, start_date, end_date, details)
    
    elif doctype == "Sales Invoice":
        return get_sales_invoice_data(customer_code, customer_name, start_date, end_date, details)

    elif doctype == "Payment Request":
        return get_payment_request_data(customer_code, customer_name, start_date, end_date, details)

    elif doctype == "Payment Entry":
        return get_payment_entry_data(customer_code, customer_name, start_date, end_date, details)


def get_sales_order_data(customer_code, customer_name, start_date, end_date, details):
    ...
    html = f"""
        ...
        <h5>Customer Code - {customer_code}</h5>
...
def get_delivery_note_data(customer_code, customer_name, start_date, end_date, details):
...
def get_sales_invoice_data(customer_code, customer_name, start_date, end_date, details):
...
def get_payment_request_data(customer_code, customer_name, start_date, end_date, details):
...
def get_payment_entry_data(customer_code, customer_name, start_date, end_date, details):
