...
def get_supplier_details(supplier_code, supplier_name, doctype, details, filters=None):
    ...
    if doctype == "Purchase Order":
        ...
        return get_purchase_receipt_data(supplier_code, supplier_name, start_date, end_date, details)
    
    elif doctype == "Purchase Invoice":
        return get_purchase_invoice_data(supplier_code, supplier_name, start_date, end_date, details)

    elif doctype == "Payment Request":
        return get_payment_request_data(supplier_code, supplier_name, start_date, end_date, details)

    elif doctype == "Payment Entry":
        return get_payment_entry_data(supplier_code, supplier_name, start_date, end_date, details)
...
def get_purchase_receipt_data(supplier_code, supplier_name, start_date, end_date, details):
...
def get_purchase_invoice_data(supplier_code, supplier_name, start_date, end_date, details):
